...
public class ExplanationRule {
    ...
    public ExplanationRule(ExplanationNorm norm) {
        this.norm = norm;
    ...
    public ExplanationRule(ExplanationRule from) {
        this.norm = from.norm;
    ...
    public boolean equals(Object o) {
        ...
        ExplanationRule rule = (ExplanationRule) o;
    ...
    public void setNorm(ExplanationNorm norm) {
        this.norm = norm;
    }

    public ExplanationNorm getNorm() {
        return norm;
    }
    ...
    public boolean subsumes(ExplanationRule other) {
