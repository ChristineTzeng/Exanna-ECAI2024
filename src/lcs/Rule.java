...
public class Rule {
    ...
    public boolean isMoreGeneral(Rule other) {
    	if (this.getNumberOfKnownBits() > other.getNumberOfKnownBits()) return false;
    	for (Object obj: this.norm.getConditions().getVector()) {
    		if (!other.norm.getConditions().getVector().contains(obj)) return false;
    	}
